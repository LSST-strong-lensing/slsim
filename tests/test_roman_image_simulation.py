...
def test_simulate_roman_image():
    ...
    deflector_dict = {'center_x': -0.007876281728887604,
    ...
    source_dict = {'angular_size': 0.1651633078964498,
    ...
    lens = Lens(source_dict=source_dict, deflector_dict=deflector_dict, los_dict=los_dict, cosmo=cosmo)

    psf_directory = os.path.join(os.path.dirname(__file__), '..', "data", "webbpsf")
    final_array = simulate_roman_image(lens, band, num_pix=45, oversample=5, add_noise=True, psf_directory=psf_directory)
