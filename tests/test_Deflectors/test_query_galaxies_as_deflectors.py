...
class TestFindPotentialLenses(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.kwargs_deflector = {'min_z':0.2, 'max_z':1.9, 'min_shear':0.001, 
                                 'max_shear':0.02, 'min_PA_shear':0.0, 
                                 'max_PA_shear':180.0}

        
        self.kwargs_source = {'type':'galaxy', 'min_z':0.2, 'max_z':5.0, 
                            'min_mag':23.0, 'max_mag':28.0, 'boost_csect':3, 
                            'ell_min':0.1, 'ell_max': 0.8, 'PA_min': 0., 
                            'PA_max':180., 'R_Einst_min': 0.5, 'R_Einst_max':3.0}
    ...
    def test_find_potential_lenses(self):
        ...
        self.assertGreater(len(sorted_table), 0, "No galaxies were identified as potential lenses.")
