...
def test_get_velocity_dispersion():
    ...
    lsst_errs = np.array([0.007, 0.005, 0.005]).reshape(1,3)        # g,r,i errors
    redshifts = np.array([0.08496])                                 #redshift

    coefficients = [0.01011,0.01920,0.05162,-0.00032,0.06555,-0.02949,0.00003,0.04040,-0.00892,
                    -0.03068,-0.21527,0.09394]         #[c1,c2,c3,c4,c5,c6,c7,c8,c9,c10,c11,c12]
    ...
    vel_disp_spec = get_velocity_dispersion(deflector_type,lsst_mags,
                                            lsst_errs,zz=redshifts,cosmo=cosmo,
                                            bands=["g", "r", "i"],c1=coefficients[0],
                                            c2=coefficients[1],c3=coefficients[2],c4=coefficients[3],
                                            c5=coefficients[4],c6=coefficients[5],c7=coefficients[6],
                                            c8=coefficients[7],c9=coefficients[8],c10=coefficients[9],
                                            c11=coefficients[10],c12=coefficients[11],
    ...
    vel_disp_wl = get_velocity_dispersion(deflector_type,lsst_mags,
                                     lsst_errs, zz=redshifts,cosmo=cosmo,
                                     bands=["g", "r", "i"], c1=coefficients[0],
                                     c2=coefficients[1],c3=coefficients[2],c4=coefficients[3],
                                     c5=coefficients[4],c6=coefficients[5],c7=coefficients[6],
