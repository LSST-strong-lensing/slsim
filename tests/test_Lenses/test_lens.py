...
class TestDifferentLens(object):
    ...
    def test_multi_plane_setting(self):
        ...
        nfw_mp_deflector_redshifts = self.lens_class_nfw_cluster_multi_source_plane.deflector_redshift
        nfw_mp_lens_model, nfw_mp_kwargs_lens = self.lens_class_nfw_cluster_multi_source_plane.deflector_mass_model_lenstronomy()
        # Test the lenght and values of the lens redshift list
