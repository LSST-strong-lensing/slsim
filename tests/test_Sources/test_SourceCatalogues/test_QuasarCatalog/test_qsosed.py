...
def mock_wavelengths():
    ...
    Must cover 4000-5000A (rest frame) to satisfy host galaxy normalization checks.
    """
...
def test_balmer_continuum(base_params):
    ...
    The Balmer break is at ~3646 Angstroms. 
    Flux shortward of 3646A should be boosted when BC is enabled .
    """
