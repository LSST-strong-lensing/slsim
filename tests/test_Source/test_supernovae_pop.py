...
class test_SNIaRate:
    ...
    def test_calculate_SNIa_rate():
        ...
        z = 0
        npt.assert_almost_equal(sne_rate.calculate_SNIa_rate(z), 0.000041006, decimal=3)
        z = 1
        npt.assert_almost_equal(sne_rate.calculate_SNIa_rate(z), 0.0001191, decimal=3)
        z = 2
        npt.assert_almost_equal(sne_rate.calculate_SNIa_rate(z), 0.0001349, decimal=3)
        z = 3
        npt.assert_almost_equal(sne_rate.calculate_SNIa_rate(z), 0.00008008, decimal=3)
