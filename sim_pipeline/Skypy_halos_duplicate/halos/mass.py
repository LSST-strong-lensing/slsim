...
def halo_mass_function(
    ...
    r"""Halo mass function. This function computes the halo mass function, defined in
    equation 7.46 in [1]_.
...
def halo_mass_sampler(
    ...
    r"""Halo mass sampler. This function samples haloes from their mass function, see
    equation 7.46 in [1]_.
...
def ellipsoidal_collapse_function(sigma, params):
    r"""Ellipsoidal collapse function. This function computes the mass function for
    ellipsoidal collapse, see equation 10 in [1]_ or [2]_.
...
def number_subhalos(halo_mass, alpha, beta, gamma_M, x, m_min, noise=True):
    r"""Number of subhalos. This function calculates the number of subhalos above a given
    initial mass for a parent halo of given mass according to the model of Vale &
    Ostriker 2004 [1]_ equation (7). The number of subhalos returned can optionally be
...
def subhalo_mass_sampler(halo_mass, nsubhalos, alpha, beta, x, m_min, resolution=100):
    r"""Subhalo mass sampler. This function samples the original, unstriped masses of
    subhaloes from the subhalo mass function of their parent halo with a constant mass
    stripping factor given by equation (1) in [1]_ and the upper subhalo mass limit from
    [2]_.
