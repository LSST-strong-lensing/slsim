...
class QuasarRate(object):
    ...
    def __init__(self, h=0.70, zeta=2.98, xi=4.05, z_star=1.60, alpha=-3.31, beta=-1.45, phi_star=5.34e-6 * (0.70**3)):
        """
    ...
    def quasar_sample(self, redshift_values, M_values, seed=42):
        ...
        """
        np.random.seed(seed)
        inverse_cdf_dict = self.inverse_cdf_fits_for_redshifts(M_values, redshift_values)
