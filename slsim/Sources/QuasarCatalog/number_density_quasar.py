...
def M_star(
    ...
    """ Calculates the break absolute magnitude of quasars for a given redshift according to Eq (11) in Oguri & Marshall (2010)
...
np.random.seed(42)
random_redshift_values = np.random.uniform(0, 5, 3)
