...
class QuasarHostMatch:
    ...
    def match(self):
        ...
        for redshift, M_i in zip(self.quasar_catalog["z"], self.quasar_catalog["M_i"]):
            ...
            host_galaxy_candidates = self.galaxy_catalog[
                ...
                & (self.galaxy_catalog["z"] <= (redshift + z_range))
                & (self.galaxy_catalog["M_i"] >= (M_i - M_i_range))
                & (self.galaxy_catalog["M_i"] <= (M_i + M_i_range))
            ]
            ...
            matched_catalog.add_row(host_galaxy)
        matched_catalog["z"] = self.quasar_catalog["z"]
