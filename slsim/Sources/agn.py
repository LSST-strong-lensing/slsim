...
class Agn:
    ...
    def __init__(
        ...
        **kwargs_agn_model
        ...
        if (
            self.kwargs_model["driving_variability"]
            not in supported_driving_variability
        ):
            raise ValueError(
        ...
        if "intrinsic_light_curve" in self.kwargs_model:
            self.kwargs_model["time_array"] = self.kwargs_model[
                "intrinsic_light_curve"
            ]["MJD"]
            self.kwargs_model["magnitude_array"] = self.kwargs_model[
                "intrinsic_light_curve"
            ]["ps_mag_intrinsic"]
...
def RandomAgn(
    ...
    **kwargs_agn_model
    ...
    if "intrinsic_light_curve" not in kwargs_agn_model.keys():
        ...
        kwargs_agn_model["intrinsic_light_curve"] = agn_bounds_dict[
            "intrinsic_light_curve"
