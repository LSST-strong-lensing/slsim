...
def convert_to_slsim_convention(
    ...
    :param source_size: Keyword for source size convention. If "Bernardi", 
     computes galaxy size using g-band magnitude otherwise rescales skypy source size 
     to Shibuya et al.(2015): 
     https://iopscience.iop.org/article/10.1088/0067-0049/219/2/15/pdf
    :param cosmo: astropy.cosmology instance
