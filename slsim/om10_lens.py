...
class OM10Lens(LensedSystem):
    ...
    def deflector_position(self):
        ...
        # center_x_lens = center_source[0] - r * np.cos(theta)
    ...
    def validity_test(
        ...
        z_lens = self._deflector_dict["ZLENS"]
        z_source = self._source_dict["om10z"]
        if z_lens >= z_source:
            return False
    ...
    def deflector_velocity_dispersion(self):
        ...
        """
        return self._deflector_dict["VELDISP"]
    ...
    def los_linear_distortions(self):
        ...
        phi = self._deflector_dict["PHIG"] * np.pi / 180
    ...
    def lenstronomy_kwargs(self, band="i"):
    ...
    def source_light_model_lenstronomy(self, band=None):
        ...
        if band is None:
            ...
            mag_source = self.extended_source_magnitude(band)
        size_source_arcsec = float(self._source_dict["size_true"])
