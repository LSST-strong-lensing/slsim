...
class FalsePositiveQuasarPop(object):
    ...
    def draw_field_galaxies(self, area, z_max):
        ...
        for _ in range(number_of_galaxies):
            galaxy = self._field_galaxy_population.draw_source(z_max=z_max)  # Assuming high z_max for field galaxies
    ...
    def draw_sources(self, z_max, theta_e):
        ...
        # Field galaxies
        area = 4 * (2 * max(1.5, theta_e * 3.0))**2  # Area of the box * 4 used for random placement
