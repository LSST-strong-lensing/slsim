...
def add_sky_plus_thermal_background(
    ...
    space used to generate sky background. For     possible coordinates,
    see
    https://roman-docs.stsci.edu/files/215
         024143/215024145/2/1768495040130/outlines.png :type ra: float
    or None :param dec: Coordinate in space used to generate sky
    background. For     possible coordinates, see
    https://roman-docs.stsci.edu/files/215
    ...
    :param num_pix: number of pixels per axis
    :type num_pix: integer
    :param ra: Coordinate in space used to generate sky background. For
        possible coordinates, see https://roman-docs.stsci.edu/files/215
        024143/215024145/2/1768495040130/outlines.png
    :type ra: float or None
    :param dec: Coordinate in space used to generate sky background. For
        possible coordinates, see https://roman-docs.stsci.edu/files/215
        024143/215024145/2/1768495040130/outlines.png
    :type dec: float or None
