...
This implements the Eisenstein and Hu fitting formula for the matter
power spectrum.
"""
...
def transfer_with_wiggles(wavenumber, A_s, n_s, cosmology, kwmap=0.02):
    r"""Eisenstein & Hu transfer function with wiggles. This function returns
    the Eisenstein & Hu fitting formula for the transfer function with baryon
    acoustic oscillation wiggles. This is described in [1]_ and [2]_.
...
def transfer_no_wiggles(wavenumber, A_s, n_s, cosmology):
    r"""Eisenstein & Hu transfer function without wiggles. Eisenstein & Hu
    fitting formula for the transfer function without baryon acoustic
...
def eisenstein_hu(wavenumber, A_s, n_s, cosmology, kwmap=0.02, wiggle=True):
    """Eisenstein & Hu matter power spectrum. This function returns the
    Eisenstein and Hu fitting function for the linear matter power spectrum
    with (or without) baryon acoustic oscillations, c.f. [1]_ and [2]_, using
