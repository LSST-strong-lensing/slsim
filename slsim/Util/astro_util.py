...
def generate_signal(
    ...
    :param standard_deviation: The desired standard deviation (std) of the light curve's
        variability.
    :param is_magnitude: Bool, a toggle between whether to use flux or magnitude units. If True,
        parameters new_mean_amplitude and new_standard_deviation will be assumed to have been
        input in mag instead of flux units.
    :param zero_point_mag: The reference amplitude to calculate the zero point magnitude from if
        parameter is_magnitude is set to True.
...
def generate_signal_from_generic_psd(
    ...
    :param new_mean_amplitude: The desired mean value of the light curve.
    :param new_standard_deviation: The desired standard deviation of the light curve.
    :param is_magnitude: Bool, a toggle between whether to use flux or magnitude units.
        If True, parameters new_mean_amplitude and new_standard_deviation will be
        assumed to have been input in mag instead of flux units.
    :param zero_point_mag: The reference amplitude to calculate the zero point magnitude
        from if parameter is_magnitude is set to True.
    :param seed: The random seed to be input for reproducability.
