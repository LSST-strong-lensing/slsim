...
def get_errors_Poisson(app_mag,zeropoint,exptime):
    '''
      ...
      assuming only the statistical error due to Poisson noise in the counts. Since,
      the photometric errors are not known in the LSST mock catalogs, these are just very 
      rough estimates.
