...
def variable_lens_injection(
    ...
    :param exposure_data: An astropy table of exposure data. It must contain calexp
        ...
        "time_series_images"), magnitude zero point (column name should be
        "zero_point"), psf kernel for each exposure (column name should be
        "psf_kernel"), exposure time (column name should be "expo_time"), observation
        time (column name should be "obs_time")
